    ...
    return (function() {
        ...
        1: [function(require, module, exports) {
            ...
            Pjax.prototype = {
                ...
                afterAllSwitches: function() {
                    // FF bug: Won鈥檛 autofocus fields that are inserted via JS.
            ...
            if (Pjax.isSupported()) {
                module.exports = Pjax;
            }// if there isn鈥檛 required browser functions, returning stupid api
            else {
                var stupidPjax = noop;
            ...
            module.exports = function(el) {
                ...
                if (code.match("document.write")) {
                    if (console && console.log) {
                        console.log("Script contains document.write. Can鈥檛 be executed correctly. Code skipped ", el);
                    }
                    return false;
                }
        ...
        9: [function(require, module, exports) {
            module.exports = function() {
                ...
                return (window.history && window.history.pushState && window.history.replaceState && // pushState isn鈥檛 reliable on iOS until 5.
        ...
        10: [function(require, module, exports) {
            ...
            module.exports = function(options) {
                ...
                // We can鈥檛 replace body.outerHTML or head.outerHTML.
        ...
        12: [function(require, module, exports) {
            ...
            var linkAction = function(el, event) {
                ...
                // don鈥檛 do "nothing" if user try to reload the page by clicking the same link twice
            ...
            function checkIfShouldAbort(el, event) {
                // Don鈥檛 break browser special behavior on links (like page in new window)
            ...
            module.exports = function(switches, switchesOptions, selectors, fromEl, toEl, options) {
                ...
                selectors.forEach(function(selector) {
                    ...
                    if (newEls.length !== oldEls.length) {
                        throw "DOM doesn鈥檛 look the same on new loaded page: 鈥�" + selector + "鈥� - new " + newEls.length + ", old " + oldEls.length;
                    }
